...
function watcher() {
  ...
  watch("source/pug/**/*.pug", series("pugs"));
}
...
exports.build   = series(cleanBuild, pugs, minhtml, styles, scripts, optimization, imagewebp, build);
exports.default = series(styles, pugs, scripts, server, watcher);